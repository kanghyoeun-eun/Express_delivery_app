...
const minOrderOptions = [
  ...
  { key: "10000", label: "10,000원 이하", value: 10000 },
  { key: "12000", label: "12,000원 이하", value: 12000 },
  { key: "15000", label: "15,000원 이하", value: 15000 },
  { key: "20000", label: "20,000원 이하", value: 20000 },
];
const allowedMinOrderValues = ["10,000원", "12,000원", "15,000원", "20,000원"];
...
const chickenResults = [
  ...
  { slug: "chicken-suwon-04", name: "쌍팔통닭 수원화서점", rating: "5.0(26)", time: "32분 소요", distance: "0.7km", minOrder: "20,000원", deliveryFee: "배달비 0원", discount: "최대 2000원 할인", image: "stores/chicken-suwon/04-kfc-mexicana.png", recent: "최근주문 : 숯불양념치킨", orderCount: 372, likeCount: 136, labels: ["수원페이", "온누리 쿠폰"], couponLabel: "1000원 쿠폰" },
  ...
  { slug: "chicken-suwon-08", name: "멕시카나 성대율전점", rating: "4.6(207)", time: "37분 소요", distance: "1.9km", minOrder: "20,000원", deliveryFee: "배달비 0원", discount: "최대 1000원 할인", image: "stores/chicken-suwon/08-gcova-popeyes.png", recent: "최근주문 : 마늘치킨", orderCount: 664, likeCount: 260, labels: ["수원페이"], couponLabel: "1000원 쿠폰" },
  ...
  { slug: "chicken-suwon-10", name: "바삭통통닭강정", rating: "4.9(2,623)", time: "33분 소요", distance: "2.2km", minOrder: "12,000원", deliveryFee: "배달비 0원", discount: "배달비 혜택 없음", image: "stores/chicken-suwon/10-mexicana-puradak.png", recent: "최근주문 : 깐풍치킨", orderCount: 810, likeCount: 322, labels: [], couponLabel: false, badges: ["리뷰이벤트"] },
  ...
  { slug: "chicken-suwon-16", name: "누구나홀딱반한닭 수원화서점", rating: "4.7(579)", time: "34분 소요", distance: "0.6km", minOrder: "20,000원", deliveryFee: "배달비 0원", discount: "온누리 쿠폰 사용 가능", image: "stores/chicken-suwon/03-old-ssangpal.png", recent: "최근주문 : 순살치킨", orderCount: 1248, likeCount: 88, labels: ["온누리 쿠폰", "G드림카드"], couponLabel: "3000원 쿠폰" },
  ...
  { slug: "chicken-suwon-20", name: "하진옛날통닭 천천점", rating: "4.9(518)", time: "28분 소요", distance: "1.8km", minOrder: "20,000원", deliveryFee: "배달비 0원", discount: "배달비 혜택 없음", image: "stores/chicken-suwon/07-dakgangjeong.png", recent: "최근주문 : 깐풍치킨", orderCount: 140, likeCount: 212, labels: [], couponLabel: false },
  ...
  { slug: "chicken-suwon-24", name: "교촌치킨 화서문점", rating: "5.0(26)", time: "32분 소요", distance: "2.3km", minOrder: "20,000원", deliveryFee: "배달비 0원", discount: "최대 2000원 할인", image: "stores/chicken-suwon/11-bbq-old.png", recent: "최근주문 : 숯불양념치킨", orderCount: 432, likeCount: 336, labels: ["수원페이", "온누리 쿠폰"], couponLabel: "1000원 쿠폰" },
  ...
  { slug: "chicken-suwon-28", name: "굽네치킨 정자동점", rating: "4.6(207)", time: "37분 소요", distance: "0.5km", minOrder: "20,000원", deliveryFee: "배달비 0원", discount: "최대 1000원 할인", image: "stores/chicken-suwon/02-gcova.png", recent: "최근주문 : 마늘치킨", orderCount: 724, likeCount: 40, labels: ["수원페이"], couponLabel: "1000원 쿠폰" },
  ...
  { slug: "chicken-suwon-30", name: "호식이두마리치킨 정자점", rating: "4.9(2,623)", time: "33분 소요", distance: "0.7km", minOrder: "12,000원", deliveryFee: "배달비 0원", discount: "배달비 혜택 없음", image: "stores/chicken-suwon/04-kfc-mexicana.png", recent: "최근주문 : 깐풍치킨", orderCount: 870, likeCount: 102, labels: [], couponLabel: false },
  ...
  { slug: "chicken-suwon-36", name: "보드람치킨 구운동점", rating: "4.7(579)", time: "34분 소요", distance: "2.2km", minOrder: "20,000원", deliveryFee: "배달비 0원", discount: "온누리 쿠폰 사용 가능", image: "stores/chicken-suwon/10-mexicana-puradak.png", recent: "최근주문 : 순살치킨", orderCount: 1308, likeCount: 288, labels: ["온누리 쿠폰", "G드림카드"], couponLabel: "3000원 쿠폰", badges: ["최소주문금액 낮음"] },
  ...
  { slug: "chicken-suwon-40", name: "후라이드참잘하는집 정자동점", rating: "4.9(518)", time: "28분 소요", distance: "0.4km", minOrder: "20,000원", deliveryFee: "배달비 0원", discount: "배달비 혜택 없음", image: "stores/chicken-suwon/01-bhc.png", recent: "최근주문 : 깐풍치킨", orderCount: 200, likeCount: 412, labels: [], couponLabel: false },
  ...
  { slug: "chicken-suwon-44", name: "오늘통닭 수원정자점", rating: "5.0(26)", time: "32분 소요", distance: "1.5km", minOrder: "20,000원", deliveryFee: "배달비 0원", discount: "최대 2000원 할인", image: "stores/chicken-suwon/05-mexicana-basak.png", recent: "최근주문 : 숯불양념치킨", orderCount: 492, likeCount: 116, labels: ["수원페이", "온누리 쿠폰"], couponLabel: "1000원 쿠폰" },
  ...
  { slug: "chicken-suwon-48", name: "오태식해바라기치킨 구운점", rating: "4.6(207)", time: "37분 소요", distance: "2.0km", minOrder: "20,000원", deliveryFee: "배달비 0원", discount: "최대 1000원 할인", image: "stores/chicken-suwon/09-holddak-baeksa.png", recent: "최근주문 : 마늘치킨", orderCount: 784, likeCount: 240, labels: ["수원페이"], couponLabel: "1000원 쿠폰" },
  ...
  { slug: "chicken-suwon-50", name: "계동치킨 화서역점", rating: "4.9(2,623)", time: "33분 소요", distance: "2.3km", minOrder: "12,000원", deliveryFee: "배달비 0원", discount: "배달비 혜택 없음", image: "stores/chicken-suwon/11-bbq-old.png", recent: "최근주문 : 깐풍치킨", orderCount: 930, likeCount: 302, labels: [], couponLabel: false },
];
...
const listViewState = {
  result: { page: null, label: "샐러드", slug: "salad", filter: "sort", activeFilters: [], sortKey: "default", minOrderLimit: null },
  portfolio: { page: null, label: "쿠폰 할인", slug: "coupon-search", filter: "sort", activeFilters: [], sortKey: "default", minOrderLimit: null },
  benefit: { page: null, label: "쿠폰함", slug: "coupon", filter: "sort", activeFilters: [], sortKey: "default", minOrderLimit: null },
};
...
function minOrderOptionFor(value) {
  return minOrderOptions.find((option) => option.value === value) || minOrderOptions[0];
}

function minOrderButtonMarkup(value = null) {
  const label = value ? minOrderOptionFor(value).label : "최소주문금액";
  return `${label} <img src="./icons/20/chevron-down.svg" alt="" />`;
}

function setFilterStripState(screen, activeKey = "sort", activeKeys = null, sortKey = "default", minOrderLimit = null) {
  const activeSet = new Set(activeKeys || []);
  screen.querySelectorAll(".filter-strip button").forEach((button, index) => {
    const key = button.dataset.filter || (index === 0 ? "sort" : getFilterKey(button.textContent.trim()));
    ...
    if (key === "sort") {
      ...
      button.classList.toggle("active", Boolean(minOrderLimit));
    } else {
...
function fallbackMinOrderForStore(store, index = 0) {
  const seedSource = getStoreSlug(store) || store?.name || String(index);
  const seed = Array.from(seedSource).reduce((sum, char) => sum + char.charCodeAt(0), index);
  return allowedMinOrderValues[seed % allowedMinOrderValues.length];
}
...
function normalizeStore(store, index, contextSlug = "default") {
  return {
    ...
    minOrder: store.minOrder || fallbackMinOrderForStore(store, index),
...
function applyStoreFilters(stores, filterKeys = [], contextSlug = "default", sortKey = "default", minOrderLimit = null) {
  ...
  active.forEach((key) => {
    if (key === "price" || key === "minOrder") {
      if (minOrderLimit) results = results.filter((store) => minOrderValue(store) <= minOrderLimit);
    } else if (key === "rating") {
...
function updateResultStores() {
  const { page, slug, filter, activeFilters = [], sortKey = "default", minOrderLimit = null } = listViewState.result;
  if (!page) return;
  const resultScreen = document.querySelector('[data-screen="search-result"]');
  setFilterStripState(resultScreen, filter, activeFilters, sortKey, minOrderLimit);
  renderStoreList(resultScreen.querySelector(".large-store-list"), applyStoreFilters(page.stores, activeFilters, slug, sortKey, minOrderLimit));
}

function updatePortfolioStores() {
  const { page, slug, filter, activeFilters = [], sortKey = "default", minOrderLimit = null } = listViewState.portfolio;
  if (!page) return;
  const portfolioScreen = document.querySelector('[data-screen="portfolio-search"]');
  setFilterStripState(portfolioScreen, filter, activeFilters, sortKey, minOrderLimit);
  renderStoreList(portfolioScreen.querySelector("#portfolioStoreList"), applyStoreFilters(page.stores, activeFilters, slug, sortKey, minOrderLimit));
}

function updateBenefitStores() {
  const { page, slug, filter, sortKey = "default", minOrderLimit = null } = listViewState.benefit;
  if (!page) return;
  ...
  const filteredStores = applyStoreFilters(page.stores, filters, slug, sortKey, minOrderLimit);
...
function setResultContext(label = "샐러드", slug = "salad") {
  ...
  const resultScreen = document.querySelector('[data-screen="search-result"]');
  listViewState.result = { page, label, slug, filter: "sort", activeFilters: [], sortKey: "default", minOrderLimit: null };
...
function setPortfolioContext(label = "쿠폰 할인") {
  ...
  listViewState.portfolio = { page, label, slug: "search", filter: "sort", activeFilters: [], sortKey: "default", minOrderLimit: null };
...
function setBenefitContext(label = "쿠폰함", slug = "coupon") {
  ...
  const benefitScreen = document.querySelector('[data-screen="benefit-list"]');
  listViewState.benefit = { page, label, slug, filter: "sort", activeFilters: [], sortKey: "default", minOrderLimit: null };
...
function renderFilterButtons(filters = commonFilterLabels) {
  return filters
    .map((filterLabel, index) => {
      ...
      const filterKey = index === 0 ? "sort" : getFilterKey(filterLabel);
      const chevron = hasChevron ? `<img src="./icons/20/chevron-down.svg" alt="" />` : "";
      return `<button type="button" data-filter="${filterKey}">${filterLabel}${chevron ? ` ${chevron}` : ""}</button>`;
    })
    .join("");
}
...
function openMinOrderSheet(screen) {
  const context = sortContextForScreen(screen);
  const sheet = document.querySelector("[data-overlay=\"min-order-select\"]");
  if (!sheet) return;
  sheet.dataset.minOrderContext = context.key;
...
function applyMinOrderSelection(optionKey) {
  const overlay = document.querySelector("[data-overlay=\"min-order-select\"]");
  const contextKey = overlay?.dataset.minOrderContext || "result";
  const context = {
    result: { state: listViewState.result, update: updateResultStores },
    portfolio: { state: listViewState.portfolio, update: updatePortfolioStores },
    benefit: { state: listViewState.benefit, update: updateBenefitStores },
  }[contextKey];
  const option = minOrderOptions.find((item) => item.key === optionKey) || minOrderOptions[0];
  if (!context) return;
  const nextFilters = new Set(context.state.activeFilters || []);
  nextFilters.delete("price");
  nextFilters.delete("minOrder");
  if (option.value) nextFilters.add("minOrder");
  context.state.activeFilters = Array.from(nextFilters);
  context.state.minOrderLimit = option.value;
  context.state.filter = option.value ? "minOrder" : "sort";
  context.update();
  trackUtEvent("filter_click", {
    filter_name: option.label,
    filter_type: "minOrder",
    button_label: option.label,
    min_order_limit: option.value || "all",
  });
  if (contextKey === "benefit") {
...
function bindInteractions() {
  document.addEventListener("click", (event) => {
    ...
    const minOrderOption = event.target.closest("[data-min-order-option]");
    if (minOrderOption) {
      applyMinOrderSelection(minOrderOption.dataset.minOrderOption || "all");
      return;
    }
    ...
    if (filterButton) {
      ...
      if (filterKey === "minOrder" || filterKey === "price") {
        openMinOrderSheet(activeScreen);
        return;
      }
      trackUtEvent("filter_click", {
